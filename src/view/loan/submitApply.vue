    ...
    <ul class="formCom form-selectRight">
      <li class="icon-arrow">
        ...
        <select v-model='data.selectWay'>
          <option v-for="(option,index) of optionWay" :value='option.val' :key=index>{{option.txt}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>借款金额</span>
        ...
        <select v-model='data.selectAmount'>
          <option v-for="(option,index) of optionAmount" :value='option.val' :key=index>{{option.txt}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>借款期限</span>
        ...
        <select v-model='data.selectLimit'>
          <option v-for="(option,index) of optionLimit" :value='option.val' :key=index>{{option.txt}}</option>
        </select>
      </li>
      <li @click="goDes">
        <span>借款描述</span>
    ...
    <ul class="formCom form-selectRight mt30">
      <li class="icon-arrow">
        ...
        <select v-model='data.selectTime'>
          <option v-for="(option,index) of optionTime" :value='option.val' :key=index>{{option.txt}}</option>
        </select>
      </li>
    </ul>
    <div class="btnWarp">
