<template>
  <div class="container">
    ...
    <ul class="listCom list-arrow list-icon no-top">
      <listComponent v-for='(data,index) in list01' :class='data.cls' @click="$router.push(data.push)" :title='data.tit' :key=index>
        <template slot='right'>
    ...
    <ul class="listCom list-arrow list-icon no-top">
      <listComponent v-for='(data,index) in list02' :class='data.cls' @click="$router.push(data.push)" :title='data.tit' :key=index>
        <template slot='right'>
          <i class="hasSuc" v-show='data.isOk'>已完成</i>
        </template>
      </listComponent>
