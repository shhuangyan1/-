    ...
    <ul class="formCom">
      ...
      <li class="icon-arrow">
        ...
        <select v-model='data.selectSex'>
          <option v-for='(option,index) in optionSex' :value='option.val' :key=index>{{option.txt}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>学历</span>
        ...
        <select v-model='data.selectEdu'>
          <option v-for='(option,index) in optionEdu' :value='option.val' :key=index>{{option.txt}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>婚姻状况</span>
        ...
        <select v-model='data.selectMar'>
          <option v-for='(option,index) in optionMar' :value='option.val' :key=index>{{option.txt}}</option>
        </select>
      </li>
    </ul>
    ...
    <ul class="formCom">
      <li class="icon-arrow">
        ...
        <select v-model='data.selectProy'>
          <option v-for="(option,index) in optionProy" :value="option.code" :key=index>{{option.address}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>市</span>
        ...
        <select v-model='data.selectCity'>
          <option v-for="(option,index) in optionCity" :value="option.code" :key=index>{{option.address}}</option>
        </select>
      </li>
      <li class="icon-arrow">
        <span>区</span>
        ...
        <select v-model='data.selectDist'>
          <option v-for="(option,index) in optionDist" :value="option.code" :key=index>{{option.address}}</option>
        </select>
      </li>
      <li>
        <label>
