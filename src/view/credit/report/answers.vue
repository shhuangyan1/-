    ...
    <div class="reportAnswers">
      ...
      <ul class="ansList" id="ansList">
        <li>
          ...
          <label v-for='(option,index) in options' :class="{checked:answer01===option}" :key=index>
            <span>{{option}}</span>
        ...
        <li>
          ...
          <label v-for='(option,index) in options' :class="{checked:answer02===option}" :key=index>
            <span>{{option}}</span>
