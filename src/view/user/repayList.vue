<template>
  <div class="container">
    ...
    <template v-if='hasRecord' v-for='(data,index) in datas'>
      <div class="repayList" :key=index>
      ...
      <span class="subBtn noRadius" @click="$router.push('/user/repayGo/'+data.id+'/'+data.totalAmount)" :key=index>还款</span>
    </template>
